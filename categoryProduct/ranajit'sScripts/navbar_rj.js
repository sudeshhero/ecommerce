            ...
            <div class="row align-items-center d-flex justify-content-between">
                ...
                <div class="col-3 align-items-center d-flex justify-content-around">
                   <div> <i class="fa-regular fa-heart"></i></div>
                    <div> <span class="v-bar">|</span><i class="fa-solid fa-cart-arrow-down"></i>
                        </div>
   ...
   <div class="container">
        <div class=" row d-flex justify-content-center nav nav-tabs ">
            <!-- <div class="row d-flex justify-content-center"> -->
                ...
                <div class=" col-1 nav-item justify-content-center " onmouseenter="makeup_d()" onmouseleave="makeup_dl()" id="makeup"><a class="nav-link text-center " href="nav_makeup.html" >MAKEUP</a></div>
               
                <div class=" col-2 nav-item justify-content-center " onmouseenter="skincare_d()" onmouseleave="skincare_dl()" id="skincare"><a class="nav-link text-center " href="nav_skincare.html" >SKINCARE</a></div>

                <div class=" col-2 nav-item justify-content-center " onmouseenter="fragrance_d()" onmouseleave="fragrance_dl()"  id="fragrance"><a class="nav-link text-center " href="nav_fragrance.html" >FRAGRANCE</a></div>

                <div class=" col-2 nav-item justify-content-center " onmouseenter="haircare_d()" onmouseleave="haircare_dl()" id="haircare"><a class="nav-link text-center " href="nav_haircare.html" >HAIRCARE</a></div>
                
                <div class=" col-2 nav-item justify-content-center " onmouseenter="brushes_d()" onmouseleave="brushes_dl()"  id="brushes"><a class="nav-link text-center " href="nav_tools&brushes.html" >TOOLS & BRUSHES</a></div>
...
<!-- login page  -->
    ...
    <div id="signup-form">
        ...
        <button class="full-length" id="submit">Continue</button>
    </div>`
}
export {navbar}